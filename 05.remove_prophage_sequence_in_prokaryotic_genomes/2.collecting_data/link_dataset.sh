ln -s ../1.rm_provirus/archaea_genome_test.phigaro.phageboost.fasta
ln -s ../1.rm_provirus/archaea_genome_train.phigaro.phageboost.fasta
ln -s ../1.rm_provirus/archaea_genome_val.phigaro.phageboost.fasta
ln -s ../1.rm_provirus/bacteria_genome_test.phigaro.phageboost.fasta
ln -s ../1.rm_provirus/bacteria_genome_train.phigaro.phageboost.fasta
ln -s ../1.rm_provirus/bacteria_genome_val.phigaro.phageboost.fasta
