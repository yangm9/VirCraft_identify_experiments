...
for TYPE in "${DATASETS[@]}"; do
    ...
    # 定义当前处理的文件前缀名
    # 假设你的原始文件命名规则是: archaea_genome_train.phigaro.fasta
    INPUT_FASTA="archaea_genome_${TYPE}.phigaro.fasta"
    WORK_DIR="archaea_genome_${TYPE}_phageboost"
    ...
    bedtools getfasta -fi ${INPUT_FASTA} -bed ${TYPE}.complement.bed -fo ../archaea_genome_${TYPE}.phigaro.phageboost.fasta
