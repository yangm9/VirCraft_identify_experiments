...
for TYPE in "${DATASETS[@]}"; do
    ...
    # 定义当前处理的文件前缀名
    INPUT_FASTA="bacteria_genome_${TYPE}.phigaro.fasta"
    WORK_DIR="bacteria_genome_${TYPE}_phageboost"
    ...
    bedtools getfasta -fi ${INPUT_FASTA} -bed ${TYPE}.complement.bed -fo ../bacteria_genome_${TYPE}.phigaro.phageboost.fasta
