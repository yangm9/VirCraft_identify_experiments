...
# 定义基础路径（方便后续修改）
FASTA_BASE="/backup/yangming/VIRPHA230501MV/vc_test/mock_data/2024-GB-Benchmarking_bioinformatic_virus/4-2.fragment_rm_training/2.subsampling/val"
IDENTIFY_BASE="/backup/yangming/VIRPHA230501MV/vc_test/mock_data/2024-GB-Benchmarking_bioinformatic_virus/5-3.identify_rm_training_by_len/val"
