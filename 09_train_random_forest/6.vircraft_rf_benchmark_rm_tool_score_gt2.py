...
def run_benchmark():
    print('Loading 20260330 Expert Models and test data...')
    try:
        # Load 20260330 double expert model
        ...
        test_full = pd.read_csv('3.preprocess_ml_features/test_cleaned_matrix.csv')
